...
//#include "Character.h"
//
//inline void HealEffect::onConsume(Character& character)
//{
...
//}
//
//inline void BuffEffect::onEquip(Character& character)
//{
//
...
//}
//
//inline void BuffEffect::onUnequip(Character& character)
//{
//    character.setAttack(character.getAttack() - atkbuff);
//    character.setDefense(character.getDefense() - defbuff);
//    character.setAttackSpeed(character.getAttackSpeed() - spdbuff);
